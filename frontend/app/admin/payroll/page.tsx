...
import { DollarSign, Edit, Plus, X } from "lucide-react";
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex gap-4 text-sm">
                      <div><p className="text-slate-500 text-xs">Basic</p><p className="text-slate-300">{formatCurrency(p.basic)}</p></div>
                      <div><p className="text-slate-500 text-xs">HRA</p><p className="text-slate-300">{formatCurrency(p.hra)}</p></div>
                    </div>
                  </div>
                  <button
